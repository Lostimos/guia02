 ...
 */
package ues.edu.sv.prn335.controller;
...
import ues.edu.sv.prn335.boundary.Vehiculos;
 ...
 Vehiculos autos=new Vehiculos();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Guia01</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("Imprimiendo placas");
          Vehiculos a = new Vehiculos();
        
        List<String> s1=a.leertxt(request.getParameter("Archivo"));
